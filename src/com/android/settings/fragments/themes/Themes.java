...
package com.android.settings.fragments.themes;
...
import com.android.settings.fragments.themes.IconShapeController;
import com.android.settings.preferences.SoundPickerPreference;
...
public class Themes extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (fingerprintManager == null || !fingerprintManager.isHardwareDetected()) {
            ...
            if (!Utils.isPackageInstalled(context, "com.aetheria.udfps.icons")) {
                mIconsCategory.removePreference(mUdfpsIcon);
            }
            if (!Utils.isPackageInstalled(context, "com.aetheria.udfps.animations")) {
                mAnimationsCategory.removePreference(mUdfpsAnimation);
            }
        }
